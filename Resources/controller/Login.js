var createNewUser, fb_button, l0, l1, tt, tw_button, view, win;
...
tw_button.addEventListener('click', function(e) {
...
createNewUser = function() {
  return tt.FB.getProfile(function(json) {
    ...
    info_obj(params);
    return API.callAPI('GET', 'createUserData', params, function(json) {
