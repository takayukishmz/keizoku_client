...
data[7] = Ti.UI.createTableViewRow({
  title: 'fitness'
});
data[8] = Ti.UI.createTableViewRow({
  title: 'sport'
});
data[9] = Ti.UI.createTableViewRow({
  title: 'lifestyle'
});
data[10] = Ti.UI.createTableViewRow({
  title: 'buisiness'
});
data[11] = Ti.UI.createTableViewRow({
  title: 'entertaiment'
});
