...
// in simulator we redefine to format for StepUpWith Developer console
...
{\
	NSString * exceptionName = [@"org.stepupwith." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stepupwith";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIStepUpWithNativeItemNone = -1, 
	UIStepUpWithNativeItemSpinner = -2,
	UIStepUpWithNativeItemProgressBar = -3,
	
	UIStepUpWithNativeItemSlider = -4,
	UIStepUpWithNativeItemSwitch = -5,
	UIStepUpWithNativeItemMultiButton = -6,
	UIStepUpWithNativeItemSegmented = -7,
	
	UIStepUpWithNativeItemTextView = -8,
	UIStepUpWithNativeItemTextField = -9,
	UIStepUpWithNativeItemSearchBar = -10,
	
	UIStepUpWithNativeItemPicker = -11,
	UIStepUpWithNativeItemDatePicker = -12,
	
	UIStepUpWithNativeItemInfoLight = -13,
	UIStepUpWithNativeItemInfoDark = -14,
	
	UIStepUpWithNativeItemDisclosure = -15,
	
	UIStepUpWithNativeItemContactAdd = -16
};
