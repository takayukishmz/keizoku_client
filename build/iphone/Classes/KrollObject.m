...
//@interface StepUpWithObject : NSObject
//@end

@interface StepUpWithObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StepUpWithObject class]])
		{
			for (NSString *key in [[(StepUpWithObject*)o modules] allKeys])
			{
